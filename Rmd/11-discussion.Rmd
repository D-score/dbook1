...
single number. Milestones are selected to fit the Rasch model. The
resulting measurements can be interpreted as scores on an interval
scale, a requirement for answering questions like:
...
@engle2011, @grantham2014 and @britto2017 for recent overviews and 
initiatives.
...
The work that needs to be done is to identify milestones that overlap
between both instruments, and filter out milestones that do not fit
the $D$-score model, and estimate the item difficulties of the
milestones that remain. Booklet II will explore this possibility in
more detail.
...
data feed into the itembank, assessment of already present milestones
