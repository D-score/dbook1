...
psychosocial stimulation. According to the World Health Organization
...
```{r shortkids, echo = FALSE, fig.cap = '(ref:shortkids)', out.width='80%', fig.align='center'}
include_graphics("fig/stuntedchildren.jpg")
```

(ref:shortkids) Seven eigth-year old children standing in front of a wall
