...
```{r shortkids, fig.cap = '(ref:shortkids)'} include_graphics("fig/stuntedchildren.jpg") ``` (ref:shortkids) Seven eight-year-old children are standing in front of a wall with the line depicting the average height according to the WHO Child Growth Standards.
