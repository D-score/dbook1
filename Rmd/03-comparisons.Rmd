# New model to quantify child development {#ch:newmodel}

Chapter \@ref(ch:history) distinguished the age-based, score-based and
unit-based approaches to measurement of child development. This
chapter introduces the basic concepts for the unit-based approach.
...
-- 
In
general, we expect that this probability increases with ability
...
in more detail in Section \@ref(sec:comparisonagebased).
