...
data.long1$agegroup <- rep(NA, nrow(data.long1))
...
n <- nrow(data.long1)
for (i in 1:(n-1)){
  if (data.long1[i, "wave"] == 1){
    data.long1[i, "agegroup"] <- ifelse(is.between(data.long1[i, "age"] , 0.5, 1.5) == TRUE, 
                                        1, 0) 
  }
  else if (data.long1[i, "wave"] == 2){
    data.long1[i, "agegroup"] <- ifelse(is.between(data.long1[i, "age"] , 1.51, 2.5) == TRUE, 
                                        1, 0)
  }
  else if (data.long1[i, "wave"] == 3){
    data.long1[i, "agegroup"] <- ifelse(is.between(data.long1[i, "age"] , 2.51, 3.5) == TRUE, 
                                        1, 0)
  }
  else if (data.long1[i, "wave"] == 4){
    data.long1[i, "agegroup"] <- ifelse(is.between(data.long1[i, "age"] , 5, 7) == TRUE, 
                                        1, 0)
  }
  else if (data.long1[i, "wave"] == 5 ){
    data.long1[i, "agegroup"] <- ifelse(is.between(data.long1[i, "age"] , 8, 10) == TRUE, 
                                        1, 0)
  }
  else if (data.long1[i, "wave"] == 6){
    data.long1[i, "agegroup"] <- ifelse(is.between(data.long1[i, "age"] , 11, 13) == TRUE, 
                                        1, 0)
  }
  else if (data.long1[i, "wave"] == 7){
    data.long1[i, "agegroup"] <- ifelse(is.between(data.long1[i, "age"] , 14, 16) == TRUE, 
                                        1, 0)
  }
  else if (data.long1[i, "wave"] == 8){
    data.long1[i, "agegroup"] <- ifelse(is.between(data.long1[i, "age"] , 16, 20) == TRUE, 
                                        1, 0)
  }
  else if (data.long1[i, "wave"] == 9){
    data.long1[i, "agegroup"] <- ifelse(is.between(data.long1[i, "age"] , 21, 27) == TRUE, 
                                        1, 0)
  }
  else if (is.na(data.long1[i, "age"])){
    data.long1[i, "agegroup"] == 0
  } 
  else {
    data.long1[i, "agegroup"] <- 0
  }
...
p1 <- ggplot(subset(data.long1, wave == c(1)), aes(dscore, IQ, group = wave)) +
      geom_point(aes(col = agegroup), show.legend=F, size = 1) +
