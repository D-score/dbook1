...
This chapter focusses on an application of the $D$-score, with the
$D$-score as neurocognitive outcome at 1000 days. This chapter shows
how to use the $D$-score as neurocognitive outcome in three different
populations, at the age of two years:

* A representative sample of Dutch children;

* A cohort of preterm Dutch children;

* A sample of children living in a Togo.

First, the calculations behind the D-score are explained step-by-step
and how to do this with the D-score package by means of two example
children. Thereafter, the D-scores will be calculated for three
...
overdiagnosis of developmental delay in very preterm children and
