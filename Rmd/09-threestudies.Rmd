...
g1 <-
  ggplot(model$dscore, aes(x = agemos, y = b)) +
  theme_light() +
  scale_x_continuous("Age (in months)",
                     limits = c(0, 30),
                     breaks = seq(0, 30, 6)) +
  scale_y_continuous(paste0("D-score"),
                     limits = c(0, 75),
                     breaks = seq(0, 70, 10)) +
  ...
  geom_point(colour = "#FF7F00", size = 0.5, alpha = 0.7) +
  facet_wrap( ~ cohort, ncol = 1) +
  theme(legend.position = "none")
g2 <-
  ggplot(model$dscore, aes(x = agemos, y = daz)) +
  theme_light() +
  scale_x_continuous("Age (in months)",
                     limits = c(0, 30),
                     breaks = seq(0, 30, 6)) +
  scale_y_continuous(paste0("DAZ"),
                     limits = c(-5, 5),
                     breaks = seq(-5, 5, 1)) +
...
g1 <-
  ggplot(data2, aes(x = age_c0.75 * 12, y = d_0.75)) +
  theme_light() +
  scale_x_continuous("Age (in months) corrected",
                     limits = c(0, 30),
                     breaks = seq(0, 30, 6)) +
  scale_y_continuous(paste0("D-score"),
                     limits = c(0, 75),
  ...
  geom_line(mapping = aes(x = month, y = d, group = centile), 
            data = reference, colour = "grey", alpha = 0.3) +
  geom_point(colour = "#006CC2B3", size = 0.5) +
  facet_wrap( ~ cohort, ncol = 1) +
  theme(legend.position = "none")
g2 <-
  ggplot(data2, aes(x = age_c0.75 * 12, y = daz_0.75)) +
  theme_light() +
  scale_x_continuous("Age (in months) corrected",
                     limits = c(0, 30),
                     breaks = seq(0, 30, 6)) +
...
g1 <-
  ggplot(data2, aes(x = age_c0.00 * 12, y = d_0.00)) +
  theme_light() +
  scale_x_continuous("Calender age (in months)",
                     limits = c(0, 30),
                     breaks = seq(0, 30, 6)) +
  scale_y_continuous(paste0("D-score"),
                     limits = c(0, 75),
  ...
  theme(legend.position = "none")
g2 <-
  ggplot(data2, aes(x = age_c0.00 * 12, y = daz_0.00)) +
  theme_light() +
  scale_x_continuous("Calender age (in months)",
                     limits = c(0, 30),
                     breaks = seq(0, 30, 6)) +
...
g1 <-
  ggplot(data2, aes(x = age_c1.00 * 12, y = d_1.00)) +
  theme_light() +
  scale_x_continuous("Age (in months), fully corrected",
                     limits = c(0, 30),
                     breaks = seq(0, 30, 6)) +
  scale_y_continuous(paste0("D-score"),
                     limits = c(0, 75),
  ...
  theme(legend.position = "none")
g2 <-
  ggplot(data2, aes(x = age_c1.00 * 12, y = daz_1.00)) +
  theme_light() +
  scale_x_continuous("Age (in months), fully corrected",
                     limits = c(0, 30),
                     breaks = seq(0, 30, 6)) +
