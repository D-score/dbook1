...
four local data-assistents, and on a regular basis mailed to TNO, the
...
```
(ref:dataassistents) Three of the data-assistents who helped to digitize the paper files.
...
(ref:togoda1) Distribution of $D$-score by age labelled by neurologic
...
(ref:togoda2) Distribution of $D$-score by age labelled by Agpar score (10 minutes) lower than 8.
(Source: TOGO data).
