...
```{r bind3, echo = FALSE, warning = FALSE}
...
```{r plotcomb, echo = FALSE, warning=FALSE, results = 'hide', fig.keep = 'all'}
data_rug <- combined %>%
...
```{r grossmotor, echo = FALSE, fig.cap = '(ref:grossmotor)', fig.height = 12, warning = FALSE}
...
```{r finemotor, echo = FALSE, fig.cap = '(ref:finemotor)', fig.height = 12, warning = FALSE}
...
```{r commun, echo = FALSE, fig.cap = '(ref:commun)', fig.height = 12, warning = FALSE}
