...
a less developed child. Person fit analysis evaluates the extend to
which this is true.
...
reliability. In practice, it is perhaps more useful to have use
measure of accuracy that is less dependent of the variation within the
