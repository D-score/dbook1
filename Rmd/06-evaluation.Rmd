...
where $\hat\beta_n$ is the estimated ability of child $n$ (the child's $D$-score), and where  $\hat\delta_i$ is the estimated difficulty of item $i$. Chapter \@ref(ch:computation) describes process of parameter estimation in detail.
...
cat("There should be plot_dif here.")
