...
# >> toch dus domeinen obv de itemnamen - coloring van stef gebruiken. 
---
...
```{r plotcontent, echo=FALSE, fig.height=3, fig.show='hold', message=FALSE, warning=FALSE}
#   info_data <-
...
```{r plotconstruct, echo=FALSE, fig.height=3, fig.show='hold', message=FALSE, warning=FALSE}
...
```{r plotconcurrent, eval=FALSE, fig.height=3, fig.show='hold', message=FALSE, warning=FALSE}
