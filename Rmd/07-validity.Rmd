...
similar constructs. It can be measured by the correlation between the 
$D$-score and the total score on Bayley-III or Denver.

For a good convergent validity the correlation with the other construct
should be 0.6, or higher. Unfortunately, at present only limited data
is available for the DDI, so we cannot assess convergent validity for the
$D$-score at this point.

Divergent validity is the extent to the $D$-score is uncorrelated 
with measures of a different construct. 
...
$D$-score. However, after correction for child's age, the relation
between height and $D$-score almost disappears. This indicates that,
given age, growth and development are quite different concepts.
...
the score on a criterion that is measured later in time. For the $D$-score
we may compare to measures for IQ at the school age as a possible criterion.
...
@vlasblom2019 found strong evidence that individual milestones of the
  ...
  intellectual functioning at ages 5--10 years. It is to be expected
  that the $D$-score, which is built upon these individual items, will
  also predict limited intellectual functioning, perhaps even better.
