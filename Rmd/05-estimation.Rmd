...
```{r smoccdata2, echo = FALSE, warning = FALSE}
library(gseddata)
library(dmetric)
...
```{r itemdiflplot, echo = FALSE, fig.height = 10, fig.cap = '(ref:itemdiflplot)'}
...
```{r itemdifdplot, echo = FALSE, fig.height = 10, fig.cap = '(ref:itemdifdplot)'}
