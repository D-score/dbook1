...
The figure shows that the probability of passing an milestone increases
with ability. Milestones are ordered in difficulty from left to right. Milestone `stepping` is the easiest and `walk_alone` is most difficult. The
right. The point at which a logistic curve crosses the 50 percent line
(marked by a cross) is customarily taken as the *difficulty of the milestone*.
