...
proposed by Freud and furthered by Erikson [@erikson1963], Kohlberg's
...
periods throughout childhood. The first period, the *sensimotor
...
(ref:dynamic) A representation of the dynamic systems viewpoint on how
different combinations of skills may lead to the same end point using
different paths. Source: @berk2013.
...
Maturation is the process of becoming completely developed, much like
...
environments. Others argue that differences in development between
children are primarily driven by environmental factors, and changing
these factors could very well impact child development.

Our position in this debate has important practical consequences. If
...
development is likely to be small. On the other hand, if we think of
developmental potential as evenly distributed, with its expression
governed by the environment, then improving life circumstances may
have substantial pay-offs in terms of better development.

## Example of motor development {#sec:motorexample}

### Shirley's motor data

For illustration, we use data on loco-motor development collected in
...
need substantial assistance. Footprints left were later colored by
...
indicate missing data. A question mark in the first column occurs when
the baby was already stepping when the observation started (Virginia
Ruth, Sibyl, Donovan and Doris). Max and Martin, who have a question
mark in the second column, skipped standing and went directly from
...
achieves a new milestone of gross-motor functioning.
...
first occurrence of the next stage. Before that age, the baby is
...
stage, but this is inaccurate. Instead, difficulty of passing from one
stage to the next corresponds to the *length of the line in the
...
the same age across different children, groups or populations.
