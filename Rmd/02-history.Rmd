...
Shirley then gave empirical operationalizations of each of these
...
(ref:shirley-motor) Staircase plot indicating the age at which each baby 
...
consistent when they classify the major theories in child development
according to each position in three questions:
