...
kable(meta, 
      ...
      row.names = FALSE, 
      col.names = c("Item", "Visit", "Domain", "Label")) %>%
  kableExtra::kable_styling() %>%
  kableExtra::scroll_box(width = "100%", height = "400px")
```

Table \@ref(tab:smoccitems) shows the 57 milestones from the DDI for
ages 0 - 24 months as they were administered in the SMOCC study. The
response to each milestones is either a PASS (1) or a FAIL (0).
Children who did not pass a milestone were re-measured on that
milestone during the next visit.
...
\@ref(sec:dscoreestimation) for a detailed explaination on how to
