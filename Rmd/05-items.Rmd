...
To illustrate the interpretation of fit measures for the D-score we use the SMOCC study [@HERGREEN1994], which covers the age range 0-2 years. In the SMOCC study 57 items are asssesed to measure the D-score. 
...
model_name<- "smocc"
sm1 <- fit_dmodel(varlist=varlist,eqate=equatelist, name = model_name)
...
model1 <- fit_raschmodel(data=dat,ability_items = items, itemtable = itemtable,equate = NULL, age_unit = "years")
#model1$item_fit
#model1$beta_l
