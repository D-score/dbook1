...
from all available milestones. We can easily recognise the points
coming from the standard and additional sets. In addition, there is a
limited number of scores on easier milestones that belong to month 1.
These milestones were rescored because the child failed these
milestones at the previous visit. Rescoring effectively extends the
range of possible $D$-scores to the lower end, so now we can find some
children who have $D$-score lower than 10$D$.
...
(ref:plotdiq) Relation between $D$-score at infancy and *IQ* at age 5 years
according to three milestone sets and nine visits (SMOCC data, $n = 557$).
