...
!!!Volgende stukken tekst moeten nog even **goed herschreven** worden!!!
Goal of this chapter: show how to calculate the dscore for a child and demonstrate the dscore package. After this, the dscores will be calculated for three different populations: the reference population, population of preterm children, and population of children in LMIC. 

Demonstration of the dscore package will be done by using two examples: one of a child that is able to do all items of his/her age, and one example of a child that is not able to do all items of his/her age. (Laat de prior --> posterior --> posterior etc. zien hoe dat verandert)
...
kable(tableWS1, caption = "Example of Van Wiechenschema at the age of 15 months")
```
